...
def show_result_physion(
    ...
    if show:
        ...
        visualizer.visualize_point_cloud_and_bboxes(points, pred_corners, corners = pred_corners.reshape(pred_corners.shape[0]*pred_corners.shape[1], 3), use_points=True, output_dir=out_dir, scene_name=filename, show=False, save=False)
