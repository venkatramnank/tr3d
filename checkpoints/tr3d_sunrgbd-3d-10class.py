...
log_level = 'INFO'
work_dir = '/home/kalyanav/MS_thesis/mmdetection3d/checkpoints'
load_from = None
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root='/home/kalyanav/MS_thesis/sun_rgbd_data/',
            ann_file=
            '/home/kalyanav/MS_thesis/sun_rgbd_data/sunrgbd_infos_train.pkl',
            pipeline=[
                dict(
                    type='LoadPointsFromFile',
                    coord_type='DEPTH',
    ...
    val=dict(
        ...
        modality=dict(use_camera=False, use_lidar=True),
        data_root='/home/kalyanav/MS_thesis/sun_rgbd_data/',
        ann_file='/home/kalyanav/MS_thesis/sun_rgbd_data/sunrgbd_infos_val.pkl',
        pipeline=[
            dict(
                type='LoadPointsFromFile',
                coord_type='DEPTH',
